...
<body>
    ...
    <section class="section-page">
            ...
            <form method="post" action="<?=URL?>/admins/editar/<?=$dados['id']?>">
                <fieldset><h2>Editar Admin <i class="bi bi-pencil-fill"></i></h2></fieldset> 
           ...
           <table>
               ...
               <tr>
                ...
                <td class="campo"><div class="input-password"><input type="password" name="senha_admin" value="<?=$dados['senha_admin']?>" id="senha"    placeholder="Digite a senha do admin"><i class="bi bi-eye-slash-fill" onclick="mostrarSenha();" id="icone_ver" title="Mostrar Senha"></i></div></td>
                
            </tr>
            <tr>
              <td><label>Confimar senha: </label></td>
              <td class="campo"><input type="password" id="confirma_senha" value="<?=$dados['confirmar_senha_admin']?>"  name="confirmar_senha_admin"  placeholder="Confirme a senha do admin"></td>
              
          </tr>

           </table>
           <fieldset>
            <button class="btn-finalizar"><i class="bi bi-arrow-clockwise"></i> Atualizar Admin</button>
